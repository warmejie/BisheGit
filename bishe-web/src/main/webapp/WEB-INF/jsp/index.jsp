		...
		<div class="w3ls-header"><!--header-one--> 
			...
			<div class="w3ls-header-right">
				<ul>
					...
					<c:if test="${sessionScope.userName != null}">
					 <a href="${pageContext.request.contextPath}/signin" aria-expanded="false"><i class="fa fa-user" aria-hidden="true"></i> ${sessionScope.userName}</a>
					</c:if>
					</li>
					<li class="dropdown head-dpdn">
	...
	<!-- Large modal -->
		...
		<div class="container">
			<div class="agile-its-header">
				...
				<a class="post-w3layouts-ad" href="${pageContext.request.contextPath}post-ad">我要卖</a>
				</div>	
				<div class="clearfix"></div>
			</div>
		</div>
